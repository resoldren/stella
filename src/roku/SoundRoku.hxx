...
#ifndef SOUND_ROKU_HXX
#define SOUND_ROKU_HXX
...
class SoundRoku : public Sound
{
  ...
  public:
    ...
    */
    string name() const override { return "RokuSound"; }
  ...
  private:
	...
	int myHardwareFrequency;
	int myHardwareSamples;
	int myHardwareChannels;
#endif
  ...
  private:
    ...
    // Following constructors and assignment operators not supported
    SoundRoku() = delete;
    SoundRoku(const SoundRoku&) = delete;
